...
cd ../kamailio && ./extract.sh kamailio.$NETWORK && ./build.sh
cd ../freeswitch && ./extract.sh freeswitch.$NETWORK && ./build.sh
cd ../monster-ui && ./extract.sh monster-ui.$NETWORK && ./build.sh
cd ../
